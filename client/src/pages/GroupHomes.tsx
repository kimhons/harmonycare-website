        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-500/30 text-amber-700 dark:text-amber-400 text-sm font-semibold mb-6 animate-pulse">
              <Sparkles className="w-4 h-4" />
              <span>🔥 Founding Member Pricing - 50% Off Forever</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Lock In{" "}
              <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
            ...
            <p className="text-xl text-muted-foreground mb-2">
              Save <strong className="text-foreground">50% off</strong> regular pricing forever + <strong className="text-foreground">40% off onboarding & maintenance</strong>
            </p>
            ...
            <Card className="p-8 border-2 border-primary">
              <div className="text-center mb-6">
                ...
                <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-400 text-xs font-bold mb-3">
                  ...
                  <span>50% OFF - Founding Member</span>
                </div>
                <h3 className="text-2xl font-bold mb-2">Starter Plan</h3>
                <div className="mb-3">
                  <div className="flex items-center justify-center gap-3 mb-1">
                    <span className="text-xl text-muted-foreground line-through">$103</span>
                    <span className="px-2 py-1 bg-destructive/10 text-destructive text-xs font-bold rounded">-50%</span>
                  </div>
              ...
              <div className="bg-accent/30 rounded-lg p-4 mb-6">
                ...
                <div className="mb-2">
                  <span className="text-sm text-muted-foreground line-through">$618/month regular</span>
                </div>
                ...
                <p className="text-xs text-green-600 dark:text-green-400 font-semibold mt-1">Save $306/month = $3,672/year</p>
              </div>
